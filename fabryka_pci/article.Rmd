...
Fabryka application files, made in R [@rcoreteam2025] by using the R package *shiny* [@chang2024], and this article, written in rmarkdown [@allaire2014; @xie2018; @xie2020], are both available online in a public github repository (<https://github.com/marchaeologist/fabryka/tree/main>). When reviewing this article you can fork and clone the fabryka project repository on github to make suggestions for modifications.\pagebreak
...
Objects abandoned by prehistoric people can be treated as sedimentary
...
proposed by McPherron (2018) is used. Thanks to this method it is
possible to calculate the Benn indices and to test the orientation rate
'L' (formula (**3.**) modified from @mcpherron2018 R script) for each
...
As proposed by @mcpherron2018, a spatial investigation of the fabric
...
contain the right column names. You can use them directly in the
...
-   Benn diagrams with possible integration of @bertran2002 model (fig. \ref{fig:figure_classical_method}D)
...
-   Benn diagrams with Benn indices computed with nearest neighbours points [@mcpherron2018]
...
-   'E1', 'E2' and 'E3' are the eigenvalues [@woodcock1977]. They
    ...
    the Benn indices.
-   'IS', 'PL' and 'EL' are calculated thanks to the eigenvalues [@benn1994]. These are the Benn indices, ratios standing respectively for,
    'isotropy' with IS = E3/E1, 'elongation' with EL = 1-(E2/E1) and
    'planar' PL = 1-IS-EL
-   'L' is the vector magnitude (strength of the preferred artefact
    orientation) and 'R.p' is the p-value result of the Rayleigh test.
...
-   source code: <https://github.com/marchaeologist/fabryka/tree/main>
    \smallbreak
-   Zenodo repository of Fabryka $\beta$ 3.0: <https://doi.org/10.5281/zenodo.15207419> \smallbreak
